...
namespace Microsoft.Azure.Devices.Client
{
    ...
    {
        static readonly TimeSpan DefaultIdleTimeout = new TimeSpan(0, 2, 0);
        ...
        public IotHubConnection GetConnection(IotHubConnectionString connectionString)
        {
            if (connectionString.SharedAccessKeyName != null)
            {
                ...
                do
                {
                    cachedConnection = new CachedConnection(this, new IotHubConnection(connectionString, this.accessRights));
                    ...
                    this.connections.Add(connectionString, cachedConnection);
                }
